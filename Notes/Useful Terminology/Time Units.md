...
# **Local (Planet-based) Timescales**
_Cybertronians are traveling/ conquering species, so it makes sense that they have units of time in that easily reflect local timescales_

**(Solar) Cycle** → local day 
**Orbital Cycles** → local months 
**Stellar Cycle** → local earth year